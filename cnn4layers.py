...
def main(gpu_id, data_path, checkpoint_path, class_number, learning_rate,
         num_steps, batch_size, coef, kernel_size, stride, epoch):
...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--epoch", default = 1000, type = int, help = "number of epochs")
    args = parser.parse_args()

    main(args.gpu_id, args.data_path, args.checkpoint_path,
        args.class_number, args.learning_rate, args.num_steps,
        args.batch_size, args.coef, args.kernel_size, args.stride, args.epoch)
